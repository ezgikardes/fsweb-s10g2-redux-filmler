//bu kısmı, anayasa maddeleri belirliyoruz gibi düşünebilirz. Maddelerimizi ilk başta büyük harflerle emir gibi tanımlıyoruz. Daha sonra ise actiıon creator'larla (stajjerimiz- aşağıda camelCase ile yazdığımız kısım) action objeleri yaratıyoruz yani NE YAPILACAĞINI belirliyoruz. uygulamamızda ilgili yerlere bu stajerleri import ediyoruz. böylece, uygulamamamızda bir etkileşim sonucunda bu stajerleri reducer'a dispatch'le kargoluyoruz. reducer bu emri alıyor, tipine bakıyor (Action.type) ve NASIL YAPILACAĞINI çözüyor. Ardından ilgili değişiklikle state'i güncelliyor.
